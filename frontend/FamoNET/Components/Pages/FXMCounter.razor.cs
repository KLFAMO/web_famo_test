...
{
    public partial class FXMCounter : ComponentBase, IDisposable
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                _module = await _jsRuntime.InvokeAsync<IJSObjectReference>("import", "./Components/Pages/FXMCounter.razor.js");
        ...
        public Task StartSaving()
        {
            ...
            FileManagerComponent.AddFile(new FileStatus() { Name = Path.Combine("Data", Filename), Status = ProgressStatus.InProgress });
            IsSaving = true;
