...
def fcomb_689(fth=434830588793337):
    fb, fr, f0 = mts.get_counters_freq(['counter3','reprate','offset'])
    fabs = fcomb(fb=fb, fr=fr, f0=f0, fth=fth, fbsign=-1)
    return fabs - fth
